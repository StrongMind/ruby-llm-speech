...
Use the following working sample as a guide to your implementation: https://github.com/aws-samples/amazon-nova-samples/compare/main...StrongMind:amazon-nova-samples:ruby-example
For the tool calling, here is a python sample to reference: https://github.com/StrongMind/amazon-nova-samples/blob/ruby-example/speech-to-speech/sample-codes/console-python/nova_sonic_tool_use.py
